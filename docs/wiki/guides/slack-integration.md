---
title: "Slack Integration & Multi-Persona Setup"
created: 2026-08-25
type: wiki-guides
parent: index
tags:
...
# ⚡ Slack Integration & Multi-Persona Setup
...
- **Multi-Persona Daemon:** Run Samantha, Grace Hopper, and Marcus Aurelius concurrently as separate Slack bots from a single process (`./chat.sh --slack`).
...
- **Autonomic Action Tags:** All model actions (`[WRITE_NOTE]`, `[REMEMBER]`, `[SPAWN_SUB_AGENT]`, `[REACT]`) execute live and render confirmation badges formatted in Slack `mrkdwn`.
