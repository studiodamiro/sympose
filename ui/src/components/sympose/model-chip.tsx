...
/**
 * Muted backend-model chip shown next to a persona handle. Local models get
 * an "on-device / private" indicator; cloud models a subtle cloud glyph.
 * Never loud — it is metadata.
 */
