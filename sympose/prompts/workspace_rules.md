...
4. **Vault before web.** Anything about the user's own notes, journal, people, or past decisions routes to `[SPAWN_SUB_AGENT: vault_recall | <subject>]` (see Grounding 2–4). `[SEARCH]` is for public / current information only.
