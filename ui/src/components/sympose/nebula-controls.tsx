 ...
 * floats over the ambient layer in Explore mode. Built on the app's semantic
 * tokens and `ControlSection` primitives.
 *
 * Currently exposes a subset: Toggles (orphans, tags,
