...
/**
 * Shared popup shell — frosted `--popover` surface, preset radius, shadow +
 * hairline ring, item / trigger / destructive theming, and the open/close
 * animation. Consumed by `DropdownMenuContent` here and by the pointer-anchored
 * context menu in `components/ui/context-menu.tsx`, so a right-click menu and a
 * button dropdown render as the same component. Width is deliberately left out —
 * each caller sets its own (`--anchor-width` for the dropdown, a fixed min for
