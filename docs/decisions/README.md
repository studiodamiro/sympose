...
| [015](015-context-budget.md) | Context budget: an overflowing prompt is cut silently, so the engine sizes it (measured on Ollama and `gemma2:9b` only) | Accepted (measurements); implementation pending |
