...
Memory sharing is configured per agent via the `share_memory` boolean in [`profiles/*.yaml`](file:///Users/damiro/Development/sympose/profiles/):
...
When [`ProfileManager.build_system_prompt()`](file:///Users/damiro/Development/sympose/sympose/profiles.py) compiles the prompt for a turn:

1. **Step 1 (Universal Identity)**: Injects [`profiles/user_profile.md`](file:///Users/damiro/Development/sympose/profiles/user_profile.md).
2. **Step 2 (Shared Team Pool)**: Injects [`profiles/_shared_memory.md`](file:///Users/damiro/Development/sympose/profiles/_shared_memory.md) **only** if `share_memory: true`.
