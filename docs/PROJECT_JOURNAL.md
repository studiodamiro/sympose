...
| ADR-132 | LLM Wiki Layer: Raw/Wiki/Schema Convention & Config Knobs | Implemented | 2026-09-19 | [2026-09-19_adr-132-llm-wiki-layer-scaffolding.md](./journal/2026-09/2026-09-19_adr-132-llm-wiki-layer-scaffolding.md) |
| ADR-130 | Streaming Persona Chat Endpoint (SSE) & Structured Action Events | Implemented (backend; frontend is ADR-131) | 2026-09-19 | [2026-09-19_adr-130-streaming-chat-endpoint-structured-actions.md](./journal/2026-09/2026-09-19_adr-130-streaming-chat-endpoint-structured-actions.md) |
| ADR-129 | Vault-Write Optimistic-Concurrency Guard | Implemented | 2026-09-19 | [2026-09-19_adr-129-vault-write-optimistic-concurrency-guard.md](./journal/2026-09/2026-09-19_adr-129-vault-write-optimistic-concurrency-guard.md) |
| ADR-128 | Wiring Capability Tiers Into Skill-Driven Model Selection | Implemented (scoped down, see doc) | 2026-09-19 | [2026-09-19_adr-128-wiring-capability-tiers-into-skill-model-selection.md](./journal/2026-09/2026-09-19_adr-128-wiring-capability-tiers-into-skill-model-selection.md) |
| ADR-127 | Capability-Tier Model Routing Axis | Implemented (dormant primitive) | 2026-09-19 | [2026-09-19_adr-127-capability-tier-model-routing-axis.md](./journal/2026-09/2026-09-19_adr-127-capability-tier-model-routing-axis.md) |
| ADR-126 | Splitting config_schema.py's SETTINGS Into Section Modules | Implemented | 2026-09-19 | [2026-09-19_adr-126-splitting-config-schema-into-section-modules.md](./journal/2026-09/2026-09-19_adr-126-splitting-config-schema-into-section-modules.md) |
...
| ADR-114 | Nebula Force-Graph Mount-Crash Fix & Click-vs-Drag Threshold Recalibration (amends ADR-096, ADR-112) | Accepted (amended by ADR-115, ADR-120) | 2026-09-14 | [2026-09-14_adr-114-nebula-force-graph-mount-crash-and-click-threshold-patches.md](./journal/2026-09/2026-09-14_adr-114-nebula-force-graph-mount-crash-and-click-threshold-patches.md) |
| ADR-112 | Enable the 3D Nebula Renderer in the App Shell (amends ADR-088) | Accepted (amended by ADR-114, ADR-115, ADR-116, ADR-117) | 2026-09-14 | [2026-09-14_adr-112-enable-3d-nebula-renderer-in-app-shell.md](./journal/2026-09/2026-09-14_adr-112-enable-3d-nebula-renderer-in-app-shell.md) |
...
| ADR-096 | Patch force-graph / three-render-objects Pointer-Drag Detection & Hover Freshness | Accepted (amended by ADR-114, ADR-120) | 2026-09-12 | [2026-09-12_adr-096-patch-force-graph-pointer-drag-detection.md](./journal/2026-09/2026-09-12_adr-096-patch-force-graph-pointer-drag-detection.md) |
...
| ADR-088 | Ambient Knowledge Nebula in the App Shell (Phase A) | Accepted (amended by ADR-089, ADR-090, ADR-091, ADR-097, ADR-112) | 2026-09-11 | [2026-09-11_adr-088-ambient-knowledge-nebula-in-app-shell.md](./journal/2026-09/2026-09-11_adr-088-ambient-knowledge-nebula-in-app-shell.md) |
