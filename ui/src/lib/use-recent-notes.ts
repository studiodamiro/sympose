...
/**
 * Recently opened notes — "jump back to your working note" (per damiro),
 * rendered as its own group under Pinned in the vault panel. Same local-only
 * convention as `usePinnedNotes()` (ADR-092): a visit costs a few bytes in a
 * cookie, no vault write, no round-trip.
 *
